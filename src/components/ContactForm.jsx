...
const ContactForm = () => {
    ...
    async function handleOnSubmit(e) {
        ...
        if (!formData.email) {
            ...
            await fetch("https://weingarten-maikammer.de/mail", {
                method: "POST",
    ...
    return (
        <div className={styles.container}>
            ...
            <p class="font-text my-5">Wir bitten um Verständnis, dass wir TISCHRESERVIERUNGEN im Restaurant ausschließlich TELEFONISCH entgegennehmen.</p>
        </div>
    );
};
